describe("Submits a feedback form", () => {
  ...
  it("Should type a nasty comment", () => {
    cy.get("#comment").type(
      "I clearly have an overinflated sense of my own importance because I'm writing to berate you for something that is clearly my fault. By the way, I happen to be very rich so I can do whatever I want."
    );
  });
